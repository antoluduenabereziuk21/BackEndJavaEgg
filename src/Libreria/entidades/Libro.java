...
public class Libro {
   ...
   @OneToOne(cascade = CascadeType.ALL)
    ...
    public Libro(Long id, String titulo, int anio, int ejemplares, int ejemplaresPrestados, int ejemplaresRestantes, boolean alta, Autor autor, Editorial editorial) {
        this.id = id;
        this.titulo = titulo;
        this.anio = anio;
        this.ejemplares = ejemplares;
