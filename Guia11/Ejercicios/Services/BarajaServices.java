...
//                System.out.println("se agrega a cartas entregadas " + cartasEntregadas.getCartas().get(i).toString());
            }
        } else {
...
//                System.out.println("imprimo aux" + aux.toString());
